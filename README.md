...
Happy SVG  (Instead of using string text convert it to base64)
1) in terminal enter  base64 -i happy.svg
2) Append the output of this with   data:image/svg+xml;base64, OUTPUT
3) Check if correct paste (2) in the web browser
4) ex:  base64 -i happy.svg
